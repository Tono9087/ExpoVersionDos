...
const PELICULAS = [
  {
    ...
    anio: '2023',
    sinopsis: 'Exploración de múltiples realidades cuánticas...', 
    cartel: require('../assets/SpiderMan.png'),
  },
  {
    id: '2',
    titulo: 'Oppenheimer',
    anio: '2023',
    sinopsis: 'Desarrollo del arma definitiva de fisión.',
    cartel: require('../assets/Oppenheimer.png'),
  },
  {
    id: '3',
    titulo: 'Super Mario Bros',
    anio: '2023',
    sinopsis: 'Misión de rescate en el Reino Champiñón.',
    cartel: require('../assets/SuperMario.png'),
  },
];
